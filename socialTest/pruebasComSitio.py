...
class Test3(unittest.TestCase):
    ...
    def test_3(self):
        ...
        driver.find_element_by_xpath("//a[@ng-click='mostrarComentarios(pag.hilo)']").click() 
        driver.find_element_by_id("fpublicacion_texto").clear()
        driver.find_element_by_id("fpublicacion_texto").send_keys("Reciente")
        time.sleep(1)
        driver.find_element_by_xpath("//button[@type='submit']").click()
        time.sleep(1)
        driver.find_element_by_xpath("(//button[@ng-click='responderPublicacion(publicacion)'])[1]").click()
        driver.find_element_by_xpath("(//textarea[@id='fpublicacion_texto'])[2]").click()
        driver.find_element_by_xpath("(//textarea[@id='fpublicacion_texto'])[2]").send_keys('hola')
        driver.find_element_by_xpath("//button[@type='submit']").click()
